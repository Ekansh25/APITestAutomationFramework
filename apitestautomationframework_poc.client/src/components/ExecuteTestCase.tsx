...
const ExecuteTestCase = (props: IInterfaceProps) => {
    ...
    const passBadge = <span className="inline-flex items-center rounded-md bg-[#0cbb52] px-3 py-1 text-xs font-medium text-white ring-1 ring-inset ring-green-600/20"> Pass </span>;
    const failBadge = <span className="inline-flex items-center rounded-md bg-[#eb2013] px-3 py-1 text-xs font-medium text-white ring-1 ring-inset ring-red-600/10"> Fail </span>;
